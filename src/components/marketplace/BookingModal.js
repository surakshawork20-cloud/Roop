...
{showBookingModal && (
  ...
  >
    <div className="min-h-screen flex justify-center items-center p-4">
      ...
      <div
        className="bg-white text-black rounded-xl w-full max-w-lg 
                   p-6 space-y-5 shadow-xl mb-10"
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4 space-y-3">
        ...
        {events.map((event) => {
          ...
          return (
            ...
            >
              ...
              {alreadySent ? (
                <span className="bg-gray-200 px-4 py-2 rounded text-sm">
                  Sent
                </span>
              ) : (
                <button
        ...
        <p className="text-xs text-gray-500 leading-relaxed pt-2">
          * Roop is a platform for discovering beauty professionals...
        </p>
      </div>
